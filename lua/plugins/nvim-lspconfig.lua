...
-- List of servers to ensure are installed via Mason
  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        map('gos', require('telescope.builtin').lsp_document_symbols, '[O]pen Document [S]ymbols')
    ...
    -- This is the new Neovim 0.11+ native API approach
